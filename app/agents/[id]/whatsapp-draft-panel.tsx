...
export default function WhatsAppDraftPanel({ agentId }: { agentId: string }) {
  ...
  const createDraft = async () => {
    ...
    const response = await fetch("/api/create-whatsapp-draft-action", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
      <h2 className="mb-4 text-2xl font-black">WhatsApp Draft</h2>
      ...
      <input
        ...
        placeholder="Purpose of WhatsApp message..."
        className="mb-3 w-full rounded-xl border border-zinc-700 bg-black p-4 text-white"
      />
      ...
      <textarea
        ...
        placeholder="Context for the message..."
      ...
      >
        {loading ? "Creating Draft..." : "Create WhatsApp Draft Action"}
      </button>
